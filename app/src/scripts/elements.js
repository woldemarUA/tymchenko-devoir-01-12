...
function getVariables(xmlData) {
    ...
    // render elements des riseaux socieaux
    const linked = {
    ...
    // Render des elements de la main section qui contient le profile, les experiences, les langues les formations et premis 
    const profile = {
